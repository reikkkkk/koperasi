...
<body>
    ...
    <!-- Pinjaman Usaha Section -->
    <section class="pinjaman-section">
      <div class="container">
        <div class="pinjaman-box">
          <h2 class="pinjaman-title">Pinjaman Usaha</h2>
          <p class="pinjaman-text">
            Pinjaman usaha adalah salah satu layanan yang disediakan oleh KSP Maju Terus untuk membantu pengembangan usaha anggota. Pinjaman ini dirancang khusus untuk memenuhi kebutuhan modal usaha, baik usaha kecil, menengah, maupun besar.
          </p>

          <!-- Jenis Pinjaman Usaha -->
          <h3 class="subheading">Jenis Pinjaman Usaha</h3>
          <ul class="pinjaman-text">
            <li>Pinjaman Modal Kerja</li>
            <li>Pinjaman Investasi</li>
            <li>Pinjaman Usaha Mikro</li>
            <li>Pinjaman Pengembangan Bisnis</li>
          </ul>

          <!-- Syarat dan Ketentuan -->
          <h3 class="subheading">Syarat dan Ketentuan</h3>
          <p class="pinjaman-text">
            Berikut adalah syarat dan ketentuan untuk mengajukan pinjaman usaha di KSP Maju Terus:
          </p>
          <ul class="pinjaman-text">
            <li>Anggota aktif KSP Maju Terus</li>
            <li>Fotokopi KTP dan Kartu Anggota</li>
            <li>Proposal usaha atau rencana bisnis</li>
            <li>Laporan keuangan atau slip gaji</li>
            <li>Jaminan aset (jika diperlukan)</li>
          </ul>
