...
<body>
    ...
    <!-- end header section -->
    <!-- Cek Saldo Simpanan Section -->
    <section class="saldo-section">
        <div class="container">
          <div class="saldo-box">
            <h2 class="saldo-title">Cek Saldo Simpanan</h2>
            <p class="saldo-text">
              Silakan cek saldo simpanan Anda di KSP Maju Terus. Pastikan saldo Anda selalu cukup untuk memenuhi kebutuhan simpanan dan transaksi Anda.
            </p>
  
            <!-- Box untuk menampilkan saldo -->
            <div class="balance-box">
              Saldo Anda: Rp 5,500,000
            </div>
  
            <!-- Tombol untuk melakukan cek saldo lebih lanjut -->
            <a href="#" class="check-balance-btn">Cek Saldo Lebih Lanjut</a>
          </div>
        </div>
      </section>
      <!-- end Cek Saldo Simpanan Section -->
