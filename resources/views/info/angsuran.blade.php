...
<body>
    ...
    <!-- end header section -->
    <!-- Cek Angsuran Pinjaman Section -->
    <section class="angsuran-section">
        <div class="container">
          <div class="angsuran-box">
            <h2 class="angsuran-title">Cek Angsuran Pinjaman</h2>
            <p class="angsuran-text">
              Silakan cek angsuran pinjaman Anda di KSP Maju Terus. Pastikan pembayaran angsuran dilakukan tepat waktu untuk menghindari denda.
            </p>
  
            <!-- Box untuk menampilkan angsuran pinjaman -->
            <div class="payment-box">
              Sisa Angsuran: Rp 2,000,000 / Bulan
            </div>
  
            <!-- Tombol untuk cek detail lebih lanjut -->
            <a href="#" class="check-loan-btn">Cek Detail Angsuran</a>
          </div>
        </div>
      </section>
      <!-- end Cek Angsuran Pinjaman Section -->
