     ...
     <section class="visimisi-section" >
        <div class="container">
          <div class="visimisi-box">
            <h2 class="visimisi-title">Visi dan Misi Koperasi </h2>
            <!-- Visi -->
            <h3 class="subheading">Visi</h3>
            <p class="visimisi-text">
              Menjadi koperasi yang unggul, terpercaya, dan berkelanjutan dalam mendukung kesejahteraan ekonomi anggota melalui pelayanan yang profesional, inovatif, dan berkualitas.
            </p>
  
            <!-- Misi -->
            <h3 class="subheading">Misi</h3>
            <ul class="visimisi-text">
              <li>Meningkatkan kesejahteraan anggota melalui produk simpan pinjam yang kompetitif.</li>
              <li>Mengembangkan program-program koperasi yang inovatif dan berorientasi pada kebutuhan anggota.</li>
              <li>Menerapkan tata kelola koperasi yang transparan, akuntabel, dan bertanggung jawab.</li>
              <li>Membangun hubungan yang harmonis dan berkelanjutan dengan para anggota, mitra usaha, dan masyarakat sekitar.</li>
            </ul>
          </div>
        </div>
      </section>
