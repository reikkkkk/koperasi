    ...
    <section class="simpanan-section">
        <div class="container">
          <div class="simpanan-box">
            <h2 class="simpanan-title">Simpanan Wajib</h2>
            
            <p class="simpanan-text">
              Simpanan Wajib adalah simpanan yang harus disetorkan oleh setiap anggota secara rutin sesuai dengan ketentuan yang berlaku. Simpanan ini bertujuan untuk meningkatkan modal koperasi dan memberikan keuntungan bagi anggota.
            </p>
  
            <h3 class="subheading">Ketentuan Simpanan Wajib</h3>
            <p class="simpanan-text">
              Berikut adalah ketentuan terkait Simpanan Wajib:
            </p>
            <ul class="simpanan-text">
              <li>Setiap anggota diwajibkan untuk menyetor Simpanan Wajib sebesar Rp 50.000,- setiap bulan.</li>
              <li>Setoran Simpanan Wajib harus dilakukan paling lambat pada tanggal 5 setiap bulan.</li>
              <li>Apabila anggota tidak melakukan setoran dalam satu bulan, maka akan dikenakan denda sebesar Rp 10.000,-.</li>
              <li>Jumlah Simpanan Wajib dapat diperiksa dan ditambahkan sesuai dengan hasil rapat anggota koperasi.</li>
              <li>Simpanan Wajib akan ditransfer kembali kepada anggota sesuai ketentuan saat pengunduran diri atau pemberhentian keanggotaan.</li>
            </ul>
  
            <h3 class="subheading">Manfaat Simpanan Wajib</h3>
            <p class="simpanan-text">
              Simpanan Wajib memiliki beberapa manfaat, antara lain:
            </p>
            <ul class="simpanan-text">
              <li>Menjadi modal operasional yang penting bagi koperasi.</li>
              <li>Mendukung berbagai program dan kegiatan koperasi untuk kesejahteraan anggota.</li>
              <li>Memberikan hak kepada anggota untuk berpartisipasi dalam rapat dan keputusan koperasi.</li>
              <li>Menjadi dasar perhitungan bagi pinjaman yang dapat diajukan oleh anggota.</li>
            </ul>
          </div>
        </div>
      </section>
      <!-- end Simpanan Wajib Section -->
